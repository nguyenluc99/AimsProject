...
public class dayOfMonth {
    public static void main(String[] args) {
        ...
        String[] month4 = { "jan.", "feb.", "mar.", "apr.", "may.", "jun.", "jul.", "aug.", "sep.", "oct.", "nov.",
                "dec." };
        String[] monthf = { "january", "february", "march", "april", "may", "june", "july", "august", "september",
        ...
        while (index < 0) {
            ...
            index = Arrays.asList(monthn1).indexOf(monthStr) + Arrays.asList(monthn2).indexOf(monthStr)
                    + Arrays.asList(month3).indexOf(monthStr) + Arrays.asList(month4).indexOf(monthStr)
                    + Arrays.asList(monthf).indexOf(monthStr) + 4;
            if (index == -1) {
